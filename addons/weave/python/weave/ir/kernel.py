...
from .config import EpilogueConfig, GridConfig, PipelineConfig, WarpConfig
from .handles import BufferRef, MbarrierSpec, PhaseDomain, SmemPool, SmemView, TmemRegion
...
class Kernel(std.BaseFunc, mnemonic="weave.Kernel"):
    ...
    tmem: Any = dc.field(default=None, lang_kind="attr")
    ...
    protocols: tuple[Any, ...] = dc.field(default_factory=tuple, lang_kind="attr")
    phase_domains: tuple[PhaseDomain, ...] = dc.field(default_factory=tuple, lang_kind="attr")
    params: Any = dc.field(default=None, lang_kind="attr")
    ...
    tile_params: Any = dc.field(default=None, lang_kind="attr")
    ...
    task_times: tuple[Any, ...] = dc.field(default_factory=tuple, lang_kind="attr")
    barriers: tuple[Any, ...] = dc.field(default_factory=tuple, lang_kind="attr")
    smem_alloc: tuple[Any, ...] = dc.field(default_factory=tuple, lang_kind="attr")
    tmem_alloc: tuple[Any, ...] = dc.field(default_factory=tuple, lang_kind="attr")
