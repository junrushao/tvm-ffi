    ...
    [
        pytest.param(
            ...
            def load_global_with_layouts(
                ...
                ) = tilus.LoadGlobal(src, offsets=[0, 0], dims=[0, 1])
                return tile
            """,
        ...
        pytest.param(
            ...
            def annotate_and_reduce_layout(
                ...
                ) = tilus.Reduce(hinted, dim=1, op="sum", keepdim=False)
                return reduced
            """,
