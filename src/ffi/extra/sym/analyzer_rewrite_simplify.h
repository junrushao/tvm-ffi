...
#ifndef TVM_FFI_EXTRA_SYM_ANALYZER_REWRITE_SIMPLIFY_H_
#define TVM_FFI_EXTRA_SYM_ANALYZER_REWRITE_SIMPLIFY_H_
...
struct RewriteSimplifier::Impl : public IRMutatorWithAnalyzer {
 ...
 protected:
  ...
  Expr ApplyRewriteRules(Expr node);
...
#endif  // TVM_FFI_EXTRA_SYM_ANALYZER_REWRITE_SIMPLIFY_H_
