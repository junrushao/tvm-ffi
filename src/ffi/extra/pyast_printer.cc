...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::ObjectDef<text::NodeASTObj>(refl::init(false))
      .def_ro(
          "source_paths", &text::NodeASTObj::source_paths, refl::init(false),
          refl::default_factory(Function::FromTyped([]() -> List<text::AccessPath> { return {}; })))
      .def_rw("lineno", &text::NodeASTObj::lineno, refl::init(false),
              refl::default_value(int64_t{-1}))
      .def_rw("col_offset", &text::NodeASTObj::col_offset, refl::init(false),
              refl::default_value(int64_t{-1}))
      .def_rw("end_lineno", &text::NodeASTObj::end_lineno, refl::init(false),
              refl::default_value(int64_t{-1}))
  ...
  // StmtBlockText
  refl::ObjectDef<text::StmtBlockASTObj>().def_ro("stmts", &text::StmtBlockASTObj::stmts);
  // LiteralAST
  refl::ObjectDef<text::LiteralASTObj>()
      .def_ro("value", &text::LiteralASTObj::value)
      .def_ro("kind", &text::LiteralASTObj::kind, refl::default_value(Optional<String>{}));
  // IdAST
  refl::ObjectDef<text::IdASTObj>().def_ro("name", &text::IdASTObj::name);
  // AttrAST
  ...
  // TupleText
  refl::ObjectDef<text::TupleASTObj>().def_ro("values", &text::TupleASTObj::values);
  // ListText
  refl::ObjectDef<text::ListASTObj>().def_ro("values", &text::ListASTObj::values);
  // DictText
  refl::ObjectDef<text::DictASTObj>()
      .def_ro("keys", &text::DictASTObj::keys)
      .def_ro("values", &text::DictASTObj::values);
  // SetAST
  refl::ObjectDef<text::SetASTObj>().def_ro("values", &text::SetASTObj::values);
  ...
  // YieldAST
  refl::ObjectDef<text::YieldASTObj>().def_ro("value", &text::YieldASTObj::value,
                                              refl::default_value(Optional<text::ExprAST>{}));
  // YieldFromAST
  refl::ObjectDef<text::YieldFromASTObj>().def_ro("value", &text::YieldFromASTObj::value);
  // StarredExprAST
  refl::ObjectDef<text::StarredExprASTObj>().def_ro("value", &text::StarredExprASTObj::value);
  // AwaitExprAST
  refl::ObjectDef<text::AwaitExprASTObj>().def_ro("value", &text::AwaitExprASTObj::value);
  // WalrusExprAST
  refl::ObjectDef<text::WalrusExprASTObj>()
      .def_ro("target", &text::WalrusExprASTObj::target)
      .def_ro("value", &text::WalrusExprASTObj::value);
  // FStrAST
  refl::ObjectDef<text::FStrASTObj>().def_ro("values", &text::FStrASTObj::values);
  // FStrValueAST
  refl::ObjectDef<text::FStrValueASTObj>()
      .def_ro("value", &text::FStrValueASTObj::value)
      .def_ro("conversion", &text::FStrValueASTObj::conversion, refl::default_value(int64_t{-1}))
      .def_ro("format_spec", &text::FStrValueASTObj::format_spec,
              refl::default_value(Optional<text::ExprAST>{}));
  // SliceText
  refl::ObjectDef<text::SliceASTObj>()
      .def_ro("start", &text::SliceASTObj::start, refl::default_value(Optional<text::ExprAST>{}))
      .def_ro("stop", &text::SliceASTObj::stop, refl::default_value(Optional<text::ExprAST>{}))
      .def_ro("step", &text::SliceASTObj::step, refl::default_value(Optional<text::ExprAST>{}));
  // AssignText
  refl::ObjectDef<text::AssignASTObj>()
      .def_ro("lhs", &text::AssignASTObj::lhs)
      .def_ro("rhs", &text::AssignASTObj::rhs, refl::default_value(Optional<text::ExprAST>{}))
      .def_ro("annotation", &text::AssignASTObj::annotation,
              refl::default_value(Optional<text::ExprAST>{}))
      .def_ro("aug_op", &text::AssignASTObj::aug_op, refl::default_value(int64_t{-1}));
  // IfText
  ...
  refl::ObjectDef<text::WhileASTObj>()
      ...
      .def_ro(
          "orelse", &text::WhileASTObj::orelse,
          refl::default_factory(Function::FromTyped([]() -> List<text::StmtAST> { return {}; })));
  // ForText
  refl::ObjectDef<text::ForASTObj>()
      .def_ro("lhs", &text::ForASTObj::lhs)
      .def_ro("rhs", &text::ForASTObj::rhs)
      .def_ro("body", &text::ForASTObj::body)
      .def_ro("is_async", &text::ForASTObj::is_async, refl::default_value(false))
      .def_ro(
          "orelse", &text::ForASTObj::orelse,
          refl::default_factory(Function::FromTyped([]() -> List<text::StmtAST> { return {}; })));
  // WithText
  refl::ObjectDef<text::WithASTObj>()
      ...
      .def_ro("is_async", &text::WithASTObj::is_async, refl::default_value(false));
  // ExprStmtAST
  refl::ObjectDef<text::ExprStmtASTObj>().def_ro("expr", &text::ExprStmtASTObj::expr);
  // AssertText
  refl::ObjectDef<text::AssertASTObj>()
      .def_ro("cond", &text::AssertASTObj::cond)
      .def_ro("msg", &text::AssertASTObj::msg, refl::default_value(Optional<text::ExprAST>{}));
  // ReturnText
  ...
  refl::ObjectDef<text::FunctionASTObj>()
      ...
      .def_ro("is_async", &text::FunctionASTObj::is_async, refl::default_value(false))
  ...
  refl::ObjectDef<text::ClassASTObj>()
      ...
      .def_ro(
          "bases", &text::ClassASTObj::bases,
          refl::default_factory(Function::FromTyped([]() -> List<text::ExprAST> { return {}; })))
      .def_ro(
          "decorators", &text::ClassASTObj::decorators,
          refl::default_factory(Function::FromTyped([]() -> List<text::ExprAST> { return {}; })))
      .def_ro(
          "body", &text::ClassASTObj::body,
          refl::default_factory(Function::FromTyped([]() -> List<text::StmtAST> { return {}; })))
      .def_ro("kwargs_keys", &text::ClassASTObj::kwargs_keys,
              refl::default_factory(Function::FromTyped([]() -> List<String> { return {}; })))
      .def_ro(
          "kwargs_values", &text::ClassASTObj::kwargs_values,
          refl::default_factory(Function::FromTyped([]() -> List<text::ExprAST> { return {}; })))
  ...
  refl::ObjectDef<text::TryASTObj>()
      ...
      .def_ro(
          "orelse", &text::TryASTObj::orelse,
          refl::default_factory(Function::FromTyped([]() -> List<text::StmtAST> { return {}; })))
      .def_ro(
          "finalbody", &text::TryASTObj::finalbody,
          refl::default_factory(Function::FromTyped([]() -> List<text::StmtAST> { return {}; })))
      .def_ro("is_star", &text::TryASTObj::is_star, refl::default_value(false));
  // MatchCaseAST
