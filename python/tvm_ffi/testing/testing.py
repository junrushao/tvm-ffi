...
class TestObjectBase(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, v_i64: int = ..., v_f64: float = ..., v_str: str = ...) -> None: ...
...
class TestIntPair(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, _0: int, _1: int, /) -> None: ...
        def sum(self, /) -> int: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class TestObjectDerived(TestObjectBase):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, v_map: Mapping[Any, Any], v_array: Sequence[Any], v_i64: int = ..., v_f64: float = ..., v_str: str = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class TestNonCopyable(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, _0: int, /) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class TestCustomHash(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, _0: int, _1: str, /) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxClassBase(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, v_i64: int, v_i32: int) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
    not_field_1 = 1
...
class _TestCxxClassDerived(_TestCxxClassBase):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, v_i64: int, v_i32: int, v_f64: float, v_f32: float = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxClassDerivedDerived(_TestCxxClassDerived):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, v_i64: int, v_i32: int, v_f64: float, v_bool: bool, v_f32: float = ..., v_str: str = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxInitSubset(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, required_field: int) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxKwOnly(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, *, x: int, y: int, z: int, w: int = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxAutoInitSimple(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, x: int, y: int) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxAutoInitKwOnlyDefaults(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, p_required: int, p_default: int = ..., *, k_required: int, k_default: int = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxAutoInitParent(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, parent_required: int, parent_default: int = ...) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
...
class _TestCxxAutoInitChild(_TestCxxAutoInitParent):
    ...
    if TYPE_CHECKING:
        ...
        def __ffi_init__(self, parent_required: int, child_required: int, parent_default: int = ..., *, child_kw_only: int) -> None: ...
    # fmt: on
    # tvm-ffi-stubgen(end)
