...
def py_class_make_type(type_key: str, parent_type_index: int) -> int: ...
def py_class_append_field(type_index: int, py_field: Any) -> None: ...
def register_type_attr(type_index: int, attr_name: str, attr_value: Any) -> None: ...
def get_type_attr(type_index: int, attr_name: str) -> Any: ...
