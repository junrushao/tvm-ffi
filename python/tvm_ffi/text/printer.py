...
.. code-block:: python
    ...
    from tvm_ffi.text.printer import IRPrinter, to_python, Int
...
from .ast import Expr, Literal, Stmt
...
class PrinterConfig(Object):
    ...
    .. code-block:: python
        ...
        from tvm_ffi.text.printer import PrinterConfig
...
class IRPrinter(Object):
    ...
    .. code-block:: python
        ...
        from tvm_ffi.text.printer import IRPrinter
